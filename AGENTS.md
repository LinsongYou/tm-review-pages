...
- Keep the app focused on English semantic search.
...
3. Implement the English semantic review flow end to end.
4. Add context view and polish.
5. Optimize bundle/data shape only after the end-to-end flow works.
...
5. Add semantic search via MiniLM.
6. Add context and result-detail views.
